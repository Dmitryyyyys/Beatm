...
import { MessageSquare, Users, Heart, Bookmark, Clock, LogOut, Settings, User, Music, Edit2, Trash2, Play, Pause, ShoppingBag, Download } from 'lucide-react'
                    ...
                    <div className="p-2.5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          {purchase.track.fileUrl && (
                            <a
                              href={purchase.track.fileUrl}
                              download={`${purchase.track.title}.mp3`}
                              onClick={(e) => e.stopPropagation()}
                              className="flex items-center justify-center w-7 h-7 bg-green-600 hover:bg-green-500 rounded-full transition-colors"
                              title="Скачать трек"
                            >
